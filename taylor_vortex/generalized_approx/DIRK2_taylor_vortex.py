...
def DIRK2_taylor_vortex (steps=3, return_stability=False,name='qz',guess=None, project=[1],alpha=0.99,theta=0.5, Tol=1e-8,post_projection=False):
    # problem description
