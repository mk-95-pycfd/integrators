...
def AB2_channel_flow(steps=3, return_stability=False, name='heun',alpha=0.9,theta=None,post_projection=False):
...
# AB2_channel_flow(steps=100, return_stability=False, name='heun',alpha=0.9,theta=None,post_projection=False)