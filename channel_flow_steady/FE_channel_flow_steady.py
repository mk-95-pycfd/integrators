...
def FE_channel_flow (steps = 3,return_stability=False,alpha=0.99):
    ...
    u_bc_left_wall = lambda yu: 4.0*yu[:,0]*(1.0-yu[:,0]) # parabolic inlet
    ...
    while count < tend:
        ...
        f.right_wall(uhnp1, vhnp1, u_bc_right_wall(uhnp1[1:-1, -2]), v_bc_right_wall(vhnp1[1:, -1]))  # this won't change anything for uhnp1
    ...
    if return_stability:
        ...
        return True, [total_iters], True, press[1:-1, 1:-1].ravel()
